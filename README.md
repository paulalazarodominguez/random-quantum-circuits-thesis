...
This repository contains the numerical code used in my bachelor thesis on scrambling dynamics in random Clifford circuits.

The notebook includes:
- Bipartite entanglement entropy calculations
- Saturation time scaling
- Tripartite mutual information calculations
